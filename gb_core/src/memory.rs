use crate::cartridge::interface::Cartridge;
...
pub struct MemoryBus {
    ...
    io_registers: Box<[u8; 0x80]>, // 0xFF00 - 0xFF7F
...
impl MemoryBus {
    ...
    pub fn read_byte(&self, address: u16) -> u8 {
        ...
        match address {
            0x0000..=0x7FF | 0xA000..=0xBFFF => self.cartridge.as_ref().unwrap().read_byte(address),
            ...
            0xFF00..=0xFF7F => self.io_registers[(address - IO_REGISTERS_START) as usize],
    ...
    pub fn write_byte(&mut self, address: u16, value: u8) {
        ...
        match address {
            0x0000..=0x7FF | 0xA000..=0xBFFF => {
                self.cartridge.as_mut().unwrap().write_byte(address, value)
            }
            ...
            0xFF00..=0xFF7F => self.io_registers[(address - IO_REGISTERS_START) as usize] = value,
